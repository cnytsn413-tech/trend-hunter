...
st.subheader("Tüm Kategoriler Entegre Edilmiş Yapay Zeka Destekli Reklam Analiz Üssü")
...
# YENİ EKLEDİĞİMİZ TÜM KATEGORİLER FİLTRESİ
...
# Aktif Bütçe ve Sıralama Filtreleri
...
# --- TÜM KATEGORİLERİ İÇEREN DEVASA VE DİNAMİK VERİTABANI ---
spy_database = {
    "US (Amerika)": [
        ...
        {"title": "Adjustable Smart Counting Hula Hoop", "niche": "Fitness & Spor", "views": "8.3M", "likes": 670000, "days_running": 30, "cpa": "$9.00", "margin": "%77", "spend": 1400, "store_url": "https://fitshape-co.com", "type": "🔥 EVERGREEN PRODUCT", "hook": "Burn 500 calories while watching your favorite show! 💃 This hula hoop never drops and counts your reps automatically."}
    ],
    "EU (Avrupa Birliği)": [
        ...
        {"title": "Orthopedic Chronic Neck Stretcher", "niche": "Sağlık & Kişisel Bakım", "views": "1.9M", "likes": 130000, "days_running": 9, "cpa": "€8.00", "margin": "%82", "spend": 180, "store_url": "https://spinecare-eu.com", "type": "📈 VIRAL RISING", "hook": "Sitting at a desk all day? Relieve neck tension in just 8 minutes. 🧘‍♂️ Fast shipping inside EU!"},
        {"title": "Automatic Electric Baby Nail Trimmer", "niche": "Anne & Bebek", "views": "1.4M", "likes": 92000, "days_running": 6, "cpa": "€3.90", "margin": "%74", "spend": 110, "store_url": "https://babysafe-eu.com", "type": "📈 VIRAL RISING", "hook": "Stop worrying about scratching your newborn's skin! 👶 Safe, silent, and works even when they sleep."},
        {"title": "Fast-Absorbing Diatomite Bath Mat", "niche": "Ev & Dekorasyon", "views": "3.8M", "likes": 210000, "days_running": 15, "cpa": "€5.10", "margin": "%80", "spend": 400, "store_url": "https://drystep-mat.com", "type": "🔥 WINNING PRODUCT", "hook": "Dries in literally 3 seconds. 🧼 Say goodbye to soggy, moldy bathroom mats forever!"}
    ],
    "GB (İngiltere)": [
        ...
        {"title": "Grip Strength Trainer with Counter", "niche": "Fitness & Spor", "views": "2.4M", "likes": 180000, "days_running": 14, "cpa": "$4.10", "margin": "%73", "spend": 280, "store_url": "https://alpha-grip.co.uk", "type": "🔥 WINNING PRODUCT", "hook": "Level up your forearm veins and crush your lifting PRs. 🦾 Adjustable resistance up to 60kg."}
    ],
    "CA (Kanada)": [
        ...
        {"title": "Waterproof HD Endoscope Camera", "niche": "Teknoloji Aksesuarları", "views": "1.7M", "likes": 115000, "days_running": 7, "cpa": "$13.20", "margin": "%65", "spend": 310, "store_url": "https://inspecto-cam.com", "type": "📈 VIRAL RISING", "hook": "See into impossible places! 🔍 Perfect for plumbing, car repairs, and DIY fixes right from your smartphone."}
    ],
    "TR (Türkiye)": [
        ...
        {"title": "Siyah Nokta Temizleme Vakumu", "niche": "Güzellik & Kozmetik", "views": "850K", "likes": 61000, "days_running": 11, "cpa": "$3.20", "margin": "%78", "spend": 140, "store_url": "https://pürüzsüzcilt.com", "type": "🔥 POPÜLER", "hook": "Tek kullanımda gözenekleri derinlemesine temizler! 🧼 Cilt bakım randevularına servet ödemeyin."}
    ]
}
...
if st.sidebar.button("🕵️‍♂️ Canlı Reklam Ağını Taramaya Başla"):
    ...
    if not filtered_ads:
        st.warning(f"⚠️ Belirttiğiniz filtre kriterlerine uygun ({category_filter} - Bütçe: ${min_spend}-${max_spend}) aktif reklam bulunamadı. Lütfen filtre alanlarını genişletin.")
    else:
        st.success(f"⚡ {target_country} pazarında {category_filter} alanında {len(filtered_ads)} adet canlı reklam listelendi!")
        st.write("---")
    ...
    st.write("### 👈 Filtreleri ayarlayın ve casus yazılımı çalıştırın.")
