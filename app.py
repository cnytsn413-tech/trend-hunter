...
st.subheader("Yapay Zeka Destekli Reklam Analizi & Otomatik Son 2-3 Ay Canlı Trend Filtresi (Mayıs - Temmuz 2026)")

# --- MANUEL ÜRÜN ARAMA ALANI ---
search_query_input = st.text_input("🔍 Kelime ile Canlı Reklam Ara (Örn: Ice, Fan, Camera, Water, Cleaning...)", "", help="Arama çubuğuna bir ürün adı yazarak doğrudan filtrelerden bağımsız arama yapabilirsiniz.")
...
# --- GENİŞLETİLMİŞ VE TARİHLENDİRİLMİŞ 2026 VERİTABANI ---
# Tüm ürünlere gerçek "reklam_tarihi" eklendi. Sistem Temmuz 2026'ya göre son 2-3 ayı filtreleyecek.
spy_database = {
    "US (Amerika)": [
        {
            "title": "IceAir Portable 3-in-1 Hydro Cooling Fan", "niche": "Ev & Dekorasyon", "views": "8.4M", "likes": 640000, "days_running": 12, "cpa": 9.20, "margin": 78, "spend": 850, "store_url": "https://iceair-cool.com", "type": "🔥 HAZİRAN 2026 WINNING", 
            "hook": "Summer 2026 is hitting different! 🥵 Drop ice cubes in, turn it on, and blast -5°C instant arctic air anywhere.",
            "audience": "Sıcak yaz ayları, Ev/Ofis soğutma, Kampçılar, Öğrenci evleri | 18-45 Yaş", "trend_base": [80, 150, 240, 380, 490, 580, 640], "reklam_tarihi": "2026-06-15"
        },
        {
            "title": "Ultra-Sonic 360° Magnetic Window Cleaner", "niche": "Ev & Dekorasyon", "views": "5.1M", "likes": 390000, "days_running": 8, "cpa": 14.50, "margin": 72, "spend": 1100, "store_url": "https://glidewindow.com", "type": "📈 TEMMUZ 2026 TAZEN TREND", 
            "hook": "Clean the outside of your high-rise windows safely from the inside! 🤯 Heavy-duty magnetic lock does it for you.",
            "audience": "Ev hanımları, Rezidans/Apartman sakinleri, Temizlik tüyoları | 25-55 Yaş", "trend_base": [20, 55, 110, 190, 260, 330, 390], "reklam_tarihi": "2026-07-01"
        },
        {
            ...
            "audience": "TikTok içerik üreticileri, Fitness vloggerları, Dansçılar | 16-35 Yaş", "trend_base": [100, 220, 340, 450, 540, 630, 710], "reklam_tarihi": "2026-06-10"
        },
        {
            "title": "Wireless Waterproof Under-Water Drone Camera", "niche": "Teknoloji Aksesuarları", "views": "11.2M", "likes": 850000, "days_running": 25, "cpa": 24.00, "margin": 55, "spend": 2200, "store_url": "https://subaquacam.com", "type": "🔥 MAYIS 2026 TREND", 
            "hook": "Explore the ocean like never before. 🌊 Streams 4K live video straight to your phone while swimming.",
            "audience": "Yüzücüler, Deniz/Havuz tatili yapanlar, Balıkçılık meraklıları | 20-45 Yaş", "trend_base": [150, 300, 480, 600, 710, 790, 850], "reklam_tarihi": "2026-05-20"
        },
        {
            "title": "Vintage Leather Wallet (Eski Ürün Simülasyonu)", "niche": "Moda", "views": "100K", "likes": 5000, "days_running": 180, "cpa": 15.00, "margin": 40, "spend": 50, "store_url": "https://oldwallet.com", "type": "❌ ESKİ TREND (FİLTRELENECEK)", 
            "hook": "Old school wallet for men.", "audience": "Erkekler", "trend_base": [1, 2, 3, 4, 4, 5, 5], "reklam_tarihi": "2025-11-10"
        }
    ],
    "EU (Avrupa Birliği)": [
        {
            "title": "IceAir Portable 3-in-1 Hydro Cooling Fan", "niche": "Ev & Dekorasyon", "views": "4.2M", "likes": 310000, "days_running": 10, "cpa": 8.90, "margin": 78, "spend": 550, "store_url": "https://iceair-cool.com", "type": "🔥 HAZİRAN 2026 YAZ TRENDİ", 
            "hook": "No AC in Europe? 🇪🇺 No worries. This desktop hydro cooler feels like a mini iceberg.",
            "audience": "Avrupa yaz sıcakları, Klimasız evler, Ofis çalışanları | 20-40 Yaş", "trend_base": [30, 70, 120, 180, 230, 270, 310], "reklam_tarihi": "2026-06-18"
        },
        {
            ...
            "audience": "Kedi sahipleri, Pratik evcil hayvan çözümleri | 22-50 Yaş", "trend_base": [40, 85, 130, 175, 215, 250, 290], "reklam_tarihi": "2026-06-05"
        }
    ],
    "CA (Kanada)": [
        {
            "title": "4K Ultra-Short Throw Cinema Projector", "niche": "Teknoloji Aksesuarları", "views": "6.2M", "likes": 480000, "days_running": 14, "cpa": 22.00, "margin": 60, "spend": 1900, "store_url": "https://nextgencinema.com", "type": "🔥 HAZİRAN 2026 MEGA WINNING", 
            "hook": "Just 10cm away from the wall gives you a massive 150-inch 4K home theater. 🎬 The future of movies is here.",
            "audience": "Ev sineması, Netflix tutkunları, Lüks ev dizaynı | 25-45 Yaş", "trend_base": [50, 110, 190, 270, 350, 420, 480], "reklam_tarihi": "2026-06-22"
        },
        {
            "title": "IceAir Portable 3-in-1 Hydro Cooling Fan", "niche": "Ev & Dekorasyon", "views": "2.1M", "likes": 160000, "days_running": 6, "cpa": 9.50, "margin": 75, "spend": 310, "store_url": "https://iceair-cool.com", "type": "📈 HAZİRAN 2026 YÜKSELEN TREND", 
            "hook": "Beat the 2026 summer heat waves instantly. Ultra-quiet and USB powered! ☀️",
            "audience": "Ev dekoru, Taşınabilir klima arayanlar | 18-40 Yaş", "trend_base": [15, 40, 65, 95, 120, 145, 160], "reklam_tarihi": "2026-06-28"
        }
    ],
    "TR (Türkiye)": [
        {
            ...
            "audience": "Yaz içecekleri, Pratik mutfak aletleri, Ev partileri | 18-50 Yaş", "trend_base": [10, 25, 42, 60, 75, 88, 98], "reklam_tarihi": "2026-06-29"
        },
        {
            "title": "Taşınabilir Mini Şarjlı Hava Soğutucu", "niche": "Ev & Dekorasyon", "views": "920K", "likes": 72000, "days_running": 5, "cpa": 4.00, "margin": 70, "spend": 180, "store_url": "https://iceair-cool.com", "type": "📈 TEMMUZ 2026 YÜKSELEN TREND", 
            "hook": "Masa başı çalışanlar ve klimasız odalar için Haziran-Temmuz 2026 kurtarıcısı! 💨 İçine su ekleyin, serinleyin.",
            "audience": "Öğrenciler, Ofis çalışanları, Ekonomik serinleme | 16-40 Yaş", "trend_base": [8, 20, 35, 48, 58, 66, 72], "reklam_tarihi": "2026-07-02"
        }
    ]
}
...
if st.sidebar.button("🕵️‍♂️ Canlı Reklam Ağını Taramaya Başla") or (search_query_input != ""):
    ...
    # Bugünün tarihi (Temmuz 2026) baz alınarak 90 gün öncesi (Maksimum 3 Ay sınırı) hesaplanıyor
    BUGUN = datetime.strptime("2026-07-02", "%Y-%m-%d")
    
    if search_query_input != "":
        st.info(f"🔍 Küresel veri havuzunda '{search_query_input}' kelimesi canlı aranıyor...")
        for ad in all_ads_list:
            ad_tarih = datetime.strptime(ad["reklam_tarihi"], "%Y-%m-%d")
            gun_farki = (BUGUN - ad_tarih).days
            
            # Kelime eşleşmesi VE En fazla 90 günlük (Son 3 ay) olma şartı
            if gun_farki <= 90:
                if search_query_input.lower() in ad["title"].lower() or search_query_input.lower() in ad["niche"].lower():
                    filtered_ads.append(ad)
    else:
        st.info(f"🤖 Yapay zeka botları {target_country} pazarındaki SON 2-3 AYIN viral reklamlarını süzüyor...")
        for ad in all_ads_list:
            if ad["country"] == target_country:
                ad_tarih = datetime.strptime(ad["reklam_tarihi"], "%Y-%m-%d")
                gun_farki = (BUGUN - ad_tarih).days
                
                # Sadece son 3 ayın (90 gün) ürünlerini içeri al
                if gun_farki <= 90:
    ...
    if not filtered_ads:
        st.warning("⚠️ Son 2-3 aya ait kriterlerinize uygun canlı ürün bulunamadı.")
    else:
        st.success(f"⚡ Zaman Filtresi Aktif: Son 2-3 aya ait toplam {len(filtered_ads)} adet taze viral reklam listelendi!")
        
        # --- ÖZELLİK 1: KÜRESEL PAZAR TABLO GÖRÜNÜMÜ ---
        with st.expander("📊 Tüm Sonuçları Büyük Veri Tablosu Olarak İncele / Excel Olarak İndir"):
            df = pd.DataFrame(filtered_ads)[["title", "niche", "country", "reklam_tarihi", "views", "likes"]]
            df.columns = ["Ürün Adı", "Kategori", "Pazar Ülkesi", "Reklam Çıkış Tarihi", "Toplam İzlenme", "Toplam Beğeni"]
            st.dataframe(df, use_container_width=True)
            
            csv = df.to_csv(index=False).encode('utf-8')
            st.download_button("📥 Tabloyu CSV Olarak Bilgisayara İndir", csv, "recent_winning_products.csv", "text/csv")
        ...
        for item in filtered_ads:
            with st.container(border=True):
                ...
                with col_title:
                    ...
                    st.caption(f"Kategori: **{item['niche']}** | Pazar: **{item['country']}** | Reklam Başlangıcı: **{item['reklam_tarihi']}**")
                with col_badge:
